...
public abstract class Bt20Base extends BtHRBase {
    ...
    @Override
    public void connect(HRDeviceReference ref) {
        cancelThreads();
    ...
    public static HRDeviceReference createDeviceRef(String providerName, BluetoothDevice device) {
        return HRDeviceReference.create(providerName, device.getName(), device.getAddress());
    }
}
