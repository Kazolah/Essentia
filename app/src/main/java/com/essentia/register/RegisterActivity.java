...
public class RegisterActivity extends Activity implements LoaderCallbacks<Cursor> {
     ...
     */
    private UserRegsiterTask mRegTask = null;
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mRegTask = new UserRegsiterTask(email, password);
...
//        mNameView.setAdapter(adapter);
     ...
     * the user.
     */
    public class UserRegsiterTask extends AsyncTask<Void, Void, Boolean> {

        private final String mEmail;
        private final String mPassword;

        UserRegsiterTask(String email, String password) {
            mEmail = email;
            mPassword = password;
        }
